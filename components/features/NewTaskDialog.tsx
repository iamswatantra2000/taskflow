        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 mt-2">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              required
              autoFocus
              className="w-full bg-[var(--tf-bg-input)] border border-[var(--tf-border)] rounded-[8px] px-3 py-2 text-[13px] text-[var(--tf-text-primary)] placeholder-slate-300 dark:placeholder-[#444] outline-none focus:border-[var(--tf-accent)] focus:ring-1 focus:ring-[var(--tf-accent)] transition-colors"
            />
          </div>
