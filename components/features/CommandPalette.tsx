  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[13vh]">
      ...
      >
        ...
        <Command
          className="relative bg-white dark:bg-[#0d0d0d] border border-slate-200 dark:border-white/[0.08] rounded-[18px] overflow-hidden"
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 py-3.5 border-b border-slate-100 dark:border-white/[0.06]">
            ...
            <Command.Input
              ...
              autoFocus
              className="flex-1 bg-transparent text-[13.5px] text-slate-800 dark:text-[#ddd] placeholder-slate-300 dark:placeholder-[#333] outline-none font-medium"
            />
            <kbd className="text-[10px] font-medium text-slate-500 dark:text-[#333] bg-slate-100 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.07] rounded-[6px] px-2 py-1 shadow-[0_2px_0_0_rgba(0,0,0,0.1)] dark:shadow-[0_2px_0_0_rgba(0,0,0,0.4)] flex-shrink-0">
              ESC
            </kbd>
          </div>
          ...
          <Command.List className="max-h-[58vh] sm:max-h-[420px] overflow-y-auto p-2 pb-2.5">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <item.icon
                        size={13}
                        className={locked ? "text-slate-300 dark:text-[#333]" : "text-slate-500 dark:text-[#666] group-data-[selected=true]:text-indigo-600 dark:group-data-[selected=true]:text-indigo-400"}
                      />
                    </div>
                    ...
                    <span
                      className={`flex-1 font-medium transition-colors
                        ${locked
                          ? "text-slate-300 dark:text-[#3a3a3a]"
                          : "text-slate-600 dark:text-[#888] group-data-[selected=true]:text-slate-900 dark:group-data-[selected=true]:text-white"
                        }`}
                    >
                      {item.label}
                    </span>
              ...
              <Command.Group heading="Projects" className={GROUP_CLS}>
                {projects.map((project) => (
                  ...
                  >
                    ...
                    <span className="flex-1 font-medium text-slate-600 dark:text-[#888] group-data-[selected=true]:text-slate-900 dark:group-data-[selected=true]:text-white transition-colors">
                      {project.name}
                    </span>
                    <ArrowRight size={12} className="text-slate-300 dark:text-[#2a2a2a] group-data-[selected=true]:text-indigo-500 transition-colors" />
                  </Command.Item>
            ...
            <Command.Group heading="Actions" className={GROUP_CLS}>
              ...
              >
                ...
                <span className="flex-1 font-medium text-slate-500 dark:text-[#666] group-data-[selected=true]:text-red-500 dark:group-data-[selected=true]:text-red-300 transition-colors">
                  Sign out
                </span>
              </Command.Item>
            </Command.Group>
          ...
          {/* ── Footer ── */}
          <div className="hidden sm:flex border-t border-slate-100 dark:border-white/[0.05] px-4 py-2.5 items-center gap-5 bg-slate-50 dark:bg-white/[0.01]">
            <div className="flex items-center gap-1.5">
              <Kbd>↑</Kbd>
              <Kbd>↓</Kbd>
              <span className="text-[11px] text-slate-400 dark:text-[#2e2e2e]">navigate</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Kbd>↵</Kbd>
              <span className="text-[11px] text-slate-400 dark:text-[#2e2e2e]">open</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Kbd>ESC</Kbd>
              <span className="text-[11px] text-slate-400 dark:text-[#2e2e2e]">close</span>
            </div>
            <div className="ml-auto flex items-center gap-1.5">
              <Kbd>⌘</Kbd>
              <Kbd>K</Kbd>
              <span className="text-[11px] text-slate-400 dark:text-[#2e2e2e]">toggle</span>
            </div>
          </div>
...
function Kbd({ children }: { children: React.ReactNode }) {
  return (
    <kbd className="inline-flex items-center justify-center min-w-[22px] h-[20px] px-1.5 text-[10px] font-semibold text-slate-500 dark:text-[#333] bg-slate-100 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.07] rounded-[5px] shadow-[0_2px_0_0_rgba(0,0,0,0.1)] dark:shadow-[0_2px_0_0_rgba(0,0,0,0.5)]">
      {children}
    </kbd>
  )
}
