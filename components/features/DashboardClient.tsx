    ...
    <div className="flex-1 overflow-auto">
      ...
      <div className="h-[50px] border-b border-[#1a1a1a] flex items-center justify-between px-5 flex-shrink-0 bg-[#0d0d0d] sticky top-0 z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[13px] font-medium text-[#e0e0e0]">Dashboard</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Search size={12} />
            <span>Search</span>
            <kbd className="text-[10px] border border-[#2a2a2a] rounded px-1 ml-1">⌘K</kbd>
          </button>
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-[13px] font-medium text-[#d0d0d0]">Task board</h2>
          </div>
          <TaskBoardWrapper
            columns={columns}
            userName={userName}
