  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-4 sm:p-6 space-y-6 max-w-2xl">
        <div className="h-5 w-32 bg-slate-100 dark:bg-[var(--tf-bg-hover)] rounded animate-pulse" />
          ...
          <div key={group} className="space-y-3">
            ...
            {[...Array(group === 0 ? 4 : 3)].map((_, i) => (
              <div key={i} className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-[var(--tf-bg-hover)] animate-pulse shrink-0 mt-0.5" />
                <div className="flex-1 space-y-1.5 pt-1">
                  <div className="h-3 w-full bg-slate-100 dark:bg-[var(--tf-bg-hover)] rounded animate-pulse" />
                  <div className="h-2.5 w-1/3 bg-slate-100 dark:bg-[var(--tf-bg-hover)] rounded animate-pulse" />
                </div>
              </div>
            ))}
          </div>
