...
// ──────────────────────────────────────────────────────────────────────────────
// Navbar — server component (needs session)
// ──────────────────────────────────────────────────────────────────────────────
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 h-14 border-b border-slate-200/80 dark:border-[var(--tf-border-subtle)] bg-white/90 dark:bg-[var(--tf-bg-panel)]/85 backdrop-blur-xl">
      <div className="max-w-6xl mx-auto px-5 sm:px-6 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <LogoMark height={22} />
          <span className="font-bricolage text-[var(--tf-text-primary)]" style={{ fontWeight: 900, fontSize: 14 }}>
            TaskFlow
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {isLoggedIn ? (
            <>
              <span className="hidden sm:block font-geist text-[12.5px] text-slate-500 dark:text-[var(--tf-text-tertiary)]">
...
function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--tf-border)] py-10 sm:py-12 px-5 sm:px-6 bg-[var(--tf-bg-panel)]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10 sm:mb-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              <LogoMark height={20} />
              <span className="font-bricolage text-[var(--tf-text-primary)]" style={{ fontWeight: 900, fontSize: 14 }}>TaskFlow</span>
            </div>
            ...
            <div key={col.title}>
              ...
              {col.links.map(link => (
                <a
                  ...
                  href="#"
                  className="font-geist block text-[12.5px] text-[var(--tf-text-tertiary)] hover:text-[var(--tf-text-secondary)] transition-colors mb-2"
                >
                  {link}
                </a>
              ))}
        ...
        <div className="border-t border-[var(--tf-border)] pt-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-geist text-[11.5px] text-[var(--tf-text-tertiary)]">© 2025 TaskFlow. All rights reserved.</p>
          <p className="font-geist text-[11.5px] text-[var(--tf-text-tertiary)]">Built with Next.js · Drizzle · shadcn/ui</p>
        </div>
