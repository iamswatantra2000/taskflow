...
export default function InviteAcceptClient(props: Props) {
  return (
    <div className="min-h-screen bg-[var(--tf-bg-panel)] flex items-center justify-center p-4">
      ...
      <div
        className="relative w-full max-w-[420px] bg-[var(--tf-bg-panel)] border border-slate-200 dark:border-white/[0.08] rounded-[20px] overflow-hidden"
      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="flex items-center gap-2.5 mb-8">
            ...
            <span className="text-[15px] font-bold text-[var(--tf-text-primary)] tracking-tight">TaskFlow</span>
          </div>
          ...
          {props.state === "invalid" ? (
            ...
            <div className="text-center">
              ...
              <h1 className="text-[20px] font-bold text-[var(--tf-text-primary)] tracking-tight mb-2">
                Invalid invitation
              </h1>
              <p className="text-[13.5px] text-[var(--tf-text-tertiary)] leading-relaxed mb-7">
                {props.reason}
              </p>
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center gap-2 h-10 px-6 text-[13px] font-semibold
                  bg-slate-100 dark:bg-white/[0.05] hover:bg-slate-200 dark:hover:bg-white/[0.08] text-[var(--tf-text-secondary)] border border-slate-200 dark:border-white/[0.08]
            ...
            <div>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-[12px] font-semibold text-[var(--tf-text-tertiary)] uppercase tracking-[0.08em] mb-2">
                  You're invited
                </p>
                <h1 className="text-[22px] font-bold text-[var(--tf-text-primary)] tracking-tight leading-tight">
                  Join <span className="text-indigo-400">{props.workspaceName}</span>
                </h1>
                <p className="text-[13.5px] text-[var(--tf-text-tertiary)] mt-2">
                  <span className="text-[var(--tf-text-secondary)]">{props.inviterName}</span> invited you to collaborate on TaskFlow
                </p>
              </div>
              ...
              <div className="bg-slate-50 dark:bg-white/[0.02] border border-slate-100 dark:border-white/[0.06] rounded-[12px] p-4 mb-6 space-y-2.5">
                {[
                  ...
                  <div key={f} className="flex items-center gap-2.5">
                    ...
                    <span className="text-[12.5px] text-[var(--tf-text-tertiary)]">{f}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-2 h-11 w-full text-[13px] font-semibold
                    bg-slate-50 dark:bg-white/[0.04] hover:bg-slate-100 dark:hover:bg-white/[0.07] text-[var(--tf-text-secondary)] hover:text-slate-800 dark:hover:text-white
              ...
              <p className="text-[11px] text-slate-400 dark:text-[var(--tf-text-tertiary)] text-center mt-5">
